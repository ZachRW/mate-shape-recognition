...
#include "/Users/admin/Downloads/opencv-4.0.1/modules/video/include/opencv2/video/tracking.hpp"
#include "/Users/admin/Downloads/opencv-4.0.1/modules/video/include/opencv2/video/background_segm.hpp"
  ...
  (JNIEnv* env, jclass , jstring path, jlong flow_nativeObj)
{
    ...
    try {
        ...
        const char* utf_path = env->GetStringUTFChars(path, 0); String n_path( utf_path ? utf_path : "" ); env->ReleaseStringUTFChars(path, utf_path);
        Mat& flow = *((Mat*)flow_nativeObj);
        bool _retval_ = cv::writeOpticalFlow( n_path, flow );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jdouble JNICALL Java_org_opencv_video_Video_findTransformECC_11 (JNIEnv*, jclass, jlong, jlong, jlong, jint, jint, jint, jdouble);
...
JNIEXPORT jdouble JNICALL Java_org_opencv_video_Video_findTransformECC_12 (JNIEnv*, jclass, jlong, jlong, jlong, jint);
...
JNIEXPORT jdouble JNICALL Java_org_opencv_video_Video_findTransformECC_13 (JNIEnv*, jclass, jlong, jlong, jlong);
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        ...
        bool _retval_ = (*me)->getUseMeanNormalization(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::DISOpticalFlow>* me = (Ptr<cv::DISOpticalFlow>*) self; //TODO: check for NULL
        bool _retval_ = (*me)->getUseSpatialPropagation(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::DISOpticalFlow>* me = (Ptr<cv::DISOpticalFlow>*) self; //TODO: check for NULL
        float _retval_ = (*me)->getVariationalRefinementAlpha(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::DISOpticalFlow>* me = (Ptr<cv::DISOpticalFlow>*) self; //TODO: check for NULL
        float _retval_ = (*me)->getVariationalRefinementDelta(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::DISOpticalFlow>* me = (Ptr<cv::DISOpticalFlow>*) self; //TODO: check for NULL
        float _retval_ = (*me)->getVariationalRefinementGamma(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::DISOpticalFlow>* me = (Ptr<cv::DISOpticalFlow>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getFinestScale(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::DISOpticalFlow>* me = (Ptr<cv::DISOpticalFlow>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getGradientDescentIterations(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::DISOpticalFlow>* me = (Ptr<cv::DISOpticalFlow>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getPatchStride(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::DISOpticalFlow>* me = (Ptr<cv::DISOpticalFlow>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getVariationalRefinementIterations(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::VariationalRefinement>* me = (Ptr<cv::VariationalRefinement>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getFixedPointIterations(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::VariationalRefinement>* me = (Ptr<cv::VariationalRefinement>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getSorIterations(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
