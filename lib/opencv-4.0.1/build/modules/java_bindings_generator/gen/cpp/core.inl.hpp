...
#include "/Users/admin/Downloads/opencv-4.0.1/modules/core/include/opencv2/core/base.hpp"
#include "/Users/admin/Downloads/opencv-4.0.1/modules/core/include/opencv2/core.hpp"
#include "/Users/admin/Downloads/opencv-4.0.1/modules/core/include/opencv2/core/utility.hpp"
#include "/Users/admin/Downloads/opencv-4.0.1/modules/core/misc/java/src/cpp/core_manual.hpp"
  ...
  (JNIEnv* env, jclass , jlong a_nativeObj, jboolean quiet, jdouble minVal)
{
    ...
    try {
        LOGD("%s", method_name);
        Mat& a = *((Mat*)a_nativeObj);
        bool _retval_ = cv::checkRange( a, (bool)quiet, 0, (double)minVal );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong a_nativeObj, jboolean quiet)
{
    ...
    try {
        LOGD("%s", method_name);
        Mat& a = *((Mat*)a_nativeObj);
        bool _retval_ = cv::checkRange( a, (bool)quiet, 0 );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass )
{
    ...
    try {
        ...
        bool _retval_ = cv::ipp::useIPP_NotExact(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong src1_nativeObj, jlong src2_nativeObj, jdouble R)
{
    ...
    try {
        ...
        Mat& src1 = *((Mat*)src1_nativeObj);
        Mat& src2 = *((Mat*)src2_nativeObj);
        double _retval_ = cv::PSNR( src1, src2, (double)R );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
