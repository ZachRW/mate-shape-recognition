...
#include "/Users/admin/Downloads/opencv-4.0.1/modules/imgproc/include/opencv2/imgproc/types_c.h"
#include "/Users/admin/Downloads/opencv-4.0.1/modules/imgproc/include/opencv2/imgproc.hpp"
  ...
  (JNIEnv* env, jclass , jlong signature1_nativeObj, jlong signature2_nativeObj, jint distType, jlong cost_nativeObj)
{
    ...
    try {
        ...
        Mat& signature2 = *((Mat*)signature2_nativeObj);
        Mat& cost = *((Mat*)cost_nativeObj);
        float _retval_ = cv::wrapperEMD( signature1, signature2, (int)distType, cost, Ptr<float>() );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong image_nativeObj, jlong labels_nativeObj, jint connectivity)
{
    ...
    try {
        ...
        Mat& image = *((Mat*)image_nativeObj);
        Mat& labels = *((Mat*)labels_nativeObj);
        int _retval_ = cv::connectedComponents( image, labels, (int)connectivity );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong image_nativeObj, jlong labels_nativeObj, jlong stats_nativeObj, jlong centroids_nativeObj, jint connectivity)
{
    ...
    try {
        ...
        Mat& stats = *((Mat*)stats_nativeObj);
        Mat& centroids = *((Mat*)centroids_nativeObj);
        int _retval_ = cv::connectedComponentsWithStats( image, labels, stats, centroids, (int)connectivity );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::GeneralizedHoughBallard>* me = (Ptr<cv::GeneralizedHoughBallard>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getVotesThreshold(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::GeneralizedHough>* me = (Ptr<cv::GeneralizedHough>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getCannyHighThresh(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::GeneralizedHough>* me = (Ptr<cv::GeneralizedHough>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getCannyLowThresh(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::GeneralizedHough>* me = (Ptr<cv::GeneralizedHough>*) self; //TODO: check for NULL
        int _retval_ = (*me)->getMaxBufferSize(  );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
