...
#include "/Users/admin/Downloads/opencv-4.0.1/modules/objdetect/include/opencv2/objdetect.hpp"
#include "/Users/admin/Downloads/opencv-4.0.1/modules/objdetect/include/opencv2/objdetect/detection_based_tracker.hpp"
  ...
  (JNIEnv* env, jclass , jlong self, jlong img_nativeObj, jlong points_nativeObj)
{
    ...
    try {
        ...
        bool _retval_ = me->detect( img, points );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
