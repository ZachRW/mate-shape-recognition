...
#include "/Users/admin/Downloads/opencv-4.0.1/modules/dnn/misc/java/src/cpp/dnn_converters.hpp"
#include "/Users/admin/Downloads/opencv-4.0.1/modules/dnn/include/opencv2/dnn/dict.hpp"
#include "/Users/admin/Downloads/opencv-4.0.1/modules/dnn/include/opencv2/dnn/dnn.hpp"
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_Dnn_NMSBoxes_13 (JNIEnv*, jclass, jlong, jlong, jfloat, jfloat, jlong, jfloat, jint);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Dnn_NMSBoxes_13
  (JNIEnv* env, jclass , jlong bboxes_mat_nativeObj, jlong scores_mat_nativeObj, jfloat score_threshold, jfloat nms_threshold, jlong indices_mat_nativeObj, jfloat eta, jint top_k)
{
    static const char method_name[] = "dnn::NMSBoxes_13()";
    try {
        LOGD("%s", method_name);
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_Dnn_NMSBoxes_14 (JNIEnv*, jclass, jlong, jlong, jfloat, jfloat, jlong, jfloat);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Dnn_NMSBoxes_14
  (JNIEnv* env, jclass , jlong bboxes_mat_nativeObj, jlong scores_mat_nativeObj, jfloat score_threshold, jfloat nms_threshold, jlong indices_mat_nativeObj, jfloat eta)
{
    static const char method_name[] = "dnn::NMSBoxes_14()";
    try {
        LOGD("%s", method_name);
        std::vector<Rect2d> bboxes;
        Mat& bboxes_mat = *((Mat*)bboxes_mat_nativeObj);
...
JNIEXPORT void JNICALL Java_org_opencv_dnn_Dnn_NMSBoxes_15 (JNIEnv*, jclass, jlong, jlong, jfloat, jfloat, jlong);

JNIEXPORT void JNICALL Java_org_opencv_dnn_Dnn_NMSBoxes_15
  (JNIEnv* env, jclass , jlong bboxes_mat_nativeObj, jlong scores_mat_nativeObj, jfloat score_threshold, jfloat nms_threshold, jlong indices_mat_nativeObj)
{
    static const char method_name[] = "dnn::NMSBoxes_15()";
    try {
        LOGD("%s", method_name);
        std::vector<Rect2d> bboxes;
        Mat& bboxes_mat = *((Mat*)bboxes_mat_nativeObj);
