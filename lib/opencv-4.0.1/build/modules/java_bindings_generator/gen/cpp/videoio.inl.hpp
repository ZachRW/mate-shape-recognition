...
#include "/Users/admin/Downloads/opencv-4.0.1/modules/videoio/include/opencv2/videoio.hpp"
#include "/Users/admin/Downloads/opencv-4.0.1/modules/videoio/include/opencv2/videoio/registry.hpp"
...
JNIEXPORT jlong JNICALL Java_org_opencv_videoio_VideoCapture_VideoCapture_12 (JNIEnv*, jclass, jint, jint);
...
JNIEXPORT jlong JNICALL Java_org_opencv_videoio_VideoCapture_VideoCapture_13 (JNIEnv*, jclass, jint);
...
JNIEXPORT jlong JNICALL Java_org_opencv_videoio_VideoCapture_VideoCapture_14 (JNIEnv*, jclass);
  ...
  (JNIEnv* env, jclass , jlong self, jint index, jint apiPreference)
{
    ...
    try {
        LOGD("%s", method_name);
        cv::VideoCapture* me = (cv::VideoCapture*) self; //TODO: check for NULL
        bool _retval_ = me->open( (int)index, (int)apiPreference );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
