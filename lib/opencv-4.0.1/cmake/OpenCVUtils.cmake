...
MACRO(ocv_check_compiler_flag LANG FLAG RESULT)
  ...
  if(NOT DEFINED ${RESULT})
    ...
    if(_fname)
      ...
      MESSAGE(STATUS "Performing Display ${RESULT}${__msg}")
      TRY_COMPILE(${RESULT}
        "${CMAKE_BINARY_DIR}"
        "${_fname}"
      ...
      IF(${RESULT})
        SET(${RESULT} 1 CACHE INTERNAL "Display ${RESULT}")
        MESSAGE(STATUS "Performing Display ${RESULT} - Success")
      ELSE(${RESULT})
        MESSAGE(STATUS "Performing Display ${RESULT} - Failed")
        SET(${RESULT} "" CACHE INTERNAL "Display ${RESULT}")
        file(APPEND ${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeError.log
            "Compilation failed:\n"
            "    source file: '${_fname}'\n"
            "    check option: '${FLAG}'\n"
